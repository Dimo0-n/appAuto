    ...
    final thirdCard = Padding(
      ...
      child: Material(
        ...
        child: Container(
          ...
          child: Column(
            children: <Widget>[
              _buildIconTile(LineIcons.monero, Colors.red, 'My Wallet'),
              hr,
              _buildIconTile(LineIcons.dollarSign, Colors.blue, 'VIP Center'),
              hr,
              _buildIconTile(LineIcons.userPlus, Colors.orangeAccent, 'Find Friends'),
              hr,
              _buildIconTile(LineIcons.userClock, Colors.black, 'Blacklist'),
              hr,
